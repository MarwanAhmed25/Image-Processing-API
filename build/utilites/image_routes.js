...
var sharp_function_1 = __importDefault(require("./sharp_function"));
...
route.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var fileName, width, height, file, w, h, image, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, sharp_function_1.default)(file, w, h)];
            case 2:
                _a.sent();
                res.status(200).sendFile(image);
                return [3 /*break*/, 4];
            case 3:
                e_1 = _a.sent();
                res.status(404).send("".concat(e_1));
                return [3 /*break*/, 4];
